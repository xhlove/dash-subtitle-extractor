...
from pyshaka.util.DataViewReader import DataViewReader
...
class ParsedTFHDBox:
    ...
    def __init__(self, **kwargs):
        ...
        self.defaultSampleDuration = kwargs['defaultSampleDuration'] # type: int
...
class ParsedTRUNSample:
    ...
    def __init__(self, **kwargs):
        ...
        self.sampleCompositionTimeOffset = kwargs['sampleCompositionTimeOffset'] # type: int
